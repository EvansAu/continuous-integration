...
1. Right-click __Start course__ and open the link in a new tab.
...
- __Workflow__: A workflow is a unit of automation from start to finish, including the definition of what triggers the automation, what environment or other aspects should be taken into account during the automation, and what should happen as a result of the trigger.
...
1. Go to the __Actions tab__.
1. Click __New workflow__.
1. Search for "Simple workflow" and click __Configure__.
...
1. Check __Require a pull request before merging__.
